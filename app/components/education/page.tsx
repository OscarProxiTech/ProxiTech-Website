...
export default function EducationComponentsPage() {
  return (
    <ThemeWrapper>
      <Navbar />
      <main className="min-h-screen pt-20 bg-background">
        <div className="container mx-auto px-4 py-12">
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-heading">Component Showcase - Education Theme</h1>
            <p className="text-lg text-subheading">
              Clean, professional components in the light Education theme.
            </p>
          </div>
          ...
          <section className="mb-12">
            <Card>
              <CardHeader>
                <CardTitle>Education Theme Logos</CardTitle>
                <CardDescription>Logos optimized for light backgrounds</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap items-center gap-8 p-6 bg-muted/30 rounded-lg">
                  <div className="flex flex-col items-center gap-2">
                    <img src="/images/logos/proxitech-icon.png" alt="ProxiTech Icon" className="h-16 w-16" />
                    <span className="text-sm text-muted-foreground">Icon</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <img src="/images/branding/proxitech-education.png" alt="ProxiTech Education" className="h-12 w-auto" />
                    <span className="text-sm text-muted-foreground">Education Logo</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <img src="/images/branding/proxitech-logo.png" alt="ProxiTech Logo" className="h-12 w-auto" />
