...
function ComponentExample({ name, description, children }: { name: string; description: string; children: React.ReactNode }) {
  return (
    <Card className="bg-gray-900 border-gray-800">
      ...
      <CardContent>
        <div className="p-6 bg-gray-950 rounded-lg border border-dashed border-gray-700">
          {children}
        </div>
      </CardContent>
    </Card>
...
export default function EngineeringComponentsPage() {
  return (
    <ThemeWrapper>
      <Navbar />
      <main className="min-h-screen pt-20 bg-gray-950">
        <div className="container mx-auto px-4 py-12">
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Component Showcase - Engineering Theme</h1>
            <p className="text-lg text-gray-300">
              Modern, technical components in the dark Engineering theme.
            </p>
          </div>
          ...
          <section className="mb-12">
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-white">Engineering Theme Logos</CardTitle>
                <CardDescription className="text-gray-400">Logos optimized for dark backgrounds</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap items-center gap-8 p-6 bg-gray-950 rounded-lg">
                  <div className="flex flex-col items-center gap-2">
                    <img src="/images/logos/proxitech-icon-dark.png" alt="ProxiTech Icon Dark" className="h-16 w-16" />
                    <span className="text-sm text-gray-400">Icon (Dark)</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <img src="/images/branding/proxitech-engineering-dark.png" alt="ProxiTech Engineering Dark" className="h-12 w-auto" />
                    <span className="text-sm text-gray-400">Engineering Logo (Dark)</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <img src="/images/branding/proxitech-logo-dark.png" alt="ProxiTech Logo Dark" className="h-12 w-auto" />
                    <span className="text-sm text-gray-400">Full Logo (Dark)</span>
                  </div>
                </div>
              </CardContent>
            </Card>
